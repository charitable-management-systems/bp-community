...
const IndexPage = () => (
  <div>
    ...
    <section>
      <p>This year marks the 30th year of the BP Community Scholarship Program serving the New York and northern New Jersey area.  Since its inception, the program has awarded over $3 million and is approaching 2,000 scholarships benefiting promising students.</p>

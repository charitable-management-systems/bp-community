...
const IndexPage = () => (
  <div>
    ...
    <section>
      <p>This year marks the 35th year of the BP Community Scholarship Program serving the New York and northern New Jersey area.  Since its inception, the program has awarded over $3.5 million and over 2,100 scholarships benefiting promising students.</p>
